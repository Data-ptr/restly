                ...
                async.series(series, function(err, result) {
                    ...
                    if (err) {
                        ...
                        if (result.auth !== null &&
                            ...
                            Object.keys(result.auth).length == 1 &&
                            result.auth.exposed) {

                            var authExposed = result.auth.exposed;
                        ...
                        if (result.request !== null &&
                            ...
                            Object.keys(result.request).length == 2 &&
                            result.request.data &&
                            result.request.exposed) {

                            var requestExposed = result.request.exposed;
